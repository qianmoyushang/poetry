      ...
      <i-col span="18" style="padding-right: 12px;">
        <Card>
          ...
          <Form :model="addData" label-position="right" :label-width="80">
            <FormItem label="古诗标题">
              <i-input v-model="addData.title" clearable></i-input>
            </FormItem>
            <FormItem label="作者">
              <i-input v-model="addData.author" clearable style="width: 200px"></i-input>
            </FormItem>
            <FormItem label="古诗状态">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getArticleTag() {
        let theMap = {};
        console.log("getTag====",this.addData.tags);
      ...
      handlePublish() {
        if (this.canPublish()) {
          ...
          this.$http.request({
            ...
            // console.log("==="+this.addData.author);
